...
export default function Builder(props) {
  ...
  return (
      ...
      <div className="f-col gap-4 md:flex-row justify-evenly max-w-7xl mx-auto" ref={componentRef}>
      {!formClose && (
        <form className="p-4 bg-fuchsia-600 exclude-print md:max-w-[40%] h-screen overflow-y-scroll">
